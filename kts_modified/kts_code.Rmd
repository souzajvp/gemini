...
##### Below or equal to 9 (0); Between 10 and 29 (2); more than 30 (1)
data$rr_arred_kts  <- as.numeric(as.character(cut(data$rr_arred, breaks=c(-Inf,8,29,Inf), labels=c(0,2,1))))
```
